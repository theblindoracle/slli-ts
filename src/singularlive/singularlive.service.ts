...
class SquatComposition extends Widget<SquatPayload> {
  subcompositionId = '9b768806-7fd1-43b1-a6e6-adf1a706972b';
}
class BenchComposition extends Widget<BenchPayload> {
  subcompositionId = '117d6e66-ec38-4214-bf03-5af1e34afe17';
}
class DeadliftComposition extends Widget<DeadliftPayload> {
  subCompositionId = 'b9b21c1e-5c7a-47e3-b524-271aa4318f91';
}

class BottomBar extends Widget<BottomBarPayload> {
  subCompositionId = '4b8a60fe-8f18-46f5-b829-0601f4a6a4d8';
}

class LightsComposition extends Widget<LightsPayload> {
  subCompositionId = '0c44bb70-1af3-4f0d-bf06-dd0cf34b78bf';
}
...
class MainScene {
  ...
  private squatComp = new SquatComposition();
  private benchComp = new BenchComposition();
  private deadliftComp = new DeadliftComposition();
  private lightsComposition = new LightsComposition();

  private leftLightInfractionCompId = 'fc070e8a-bea1-4a76-a577-22f9f22307c6';
  private headLightInfractionCompId = '8af04dc1-f884-4a16-9ebf-2be05251e54c';
  private rightLightInfractionCompId = 'cf1e8966-98c6-7abb-9d03-f2beaccb92d4';
  ...
  async updateLights(refLights: RefLights) {
    ...
    const compositionUpdates: UpdateControlAppContentDTO[] = [
      {
        subcompositionId: this.lightsComposition.subcompositionId,
        payload: lightPayload,
      },
      {
        subcompositionId: this.leftLightInfractionCompId,
        payload: leftInfractionBarPayload,
      },
      {
        subcompositionId: this.rightLightInfractionCompId,
        payload: rightInfractionBarPayload,
      },
      {
        subcompositionId: this.headLightInfractionCompId,
  ...
  async playAttemptChange(currentLifter: Lifter, currentAttempt: Attempt) {
    ...
    if (currentAttempt.liftName === 'squat') {
      ...
      compositionUpdates.push({
        subcompositionId: this.squatComp.subcompositionId,
      ...
      compositionUpdates.push({
        subcompositionId: this.benchComp.subcompositionId,
      ...
      compositionUpdates.push({
        subcompositionId: this.deadliftComp.subcompositionId,
    ...
    compositionUpdates.push({
      subcompositionId: this.bottomBar.subcompositionId,
      payload: payload,
    });
